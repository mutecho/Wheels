...
# config_path="${project_root}/config/oo_build_and_fit_6bins_shared_lambda.toml"
config_path="${project_root}/config/oo_build_and_fit_6bins_shared_lambda_wenya.toml"
# config_path="${project_root}/config/oo_build_and_fit_6bins_mergemt.toml"
# config_path="${project_root}/config/oo_build_and_fit_3bins.toml"
